...
if(typeof(Validator.prototype.isArray) === "undefined"){
  Validator.prototype.isArray = function(){
    return typeof this.str === 'object' && Object.prototype.toString.call(this.str) === '[object Array]';
  };
}
...
var expressValidator = function(options) {
  ...
  return function(req, res, next) {
    ...
    req.filter = function(param) {
      ...
      var v_obj = filter.sanitize(this.param(param));
      var p = this.param(param);
      v_obj.xss = function(){
        return require('sanitizer').sanitize(p);
      };
      return v_obj;
    };
